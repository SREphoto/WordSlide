---
description: Plan for expanding WordSlide into a multi-game puzzle hub
---
...
- Premium glassmorphism UI for all games
- Shared dictionary and word list
- Daily challenges for each game
- Progress tracking across all modes
- Unified coin/achievement system
